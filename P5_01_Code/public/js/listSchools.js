...
function fillUsersSection(users) {
	...
	} else {titlesOfSections[0].style.opacity = '0';}
	...
	} else {titlesOfSections[1].style.opacity = '0';}
	...
	} else {titlesOfSections[2].style.opacity = '0';}
}
...
for (let i=0; i<blockSchools.length; i++) {
	blockSchools[i].addEventListener('click', function(){
