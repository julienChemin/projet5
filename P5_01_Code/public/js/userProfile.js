...
if (document.getElementById('blockTabsEditProfile') !== null) {
	...
	let blockProfilePicture = document.querySelector('#userProfile > header > div:first-of-type');
	let profileImg = document.querySelector('#userProfile img:first-of-type');
	...
	let profileTextBlock = document.querySelector('#userProfile > header > div:nth-of-type(2)');
	let profilePseudo = document.querySelector('#userProfile > header > div:nth-of-type(2) > span:nth-of-type(1)');
	let profileSchool = document.querySelector('#userProfile > header > div:nth-of-type(2) > span:nth-of-type(2)');
	...
	for (let i=0; i<allButtonsEditProfile.length; i++) {
		allButtonsEditProfile[i].addEventListener('click', function(){
			...
			if (document.getElementById('lastOption') !== null) {
				listContentOrderProfile.removeChild(document.getElementById('lastOption'));
			}
		});
	}
	...
	for (let i=0; i<allButtonsEditAbout.length; i++) {
		allButtonsEditAbout[i].addEventListener('click', function(){
			...
			if (document.getElementById('lastOption') !== null) {
				listContentOrderAbout.removeChild(document.getElementById('lastOption'));
			}
		});
	}
