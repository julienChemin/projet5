...
<section id="createTopic">
    ...
    <article class="container">
        <form id="addForumTopic" method="POST" action="index.php?action=updateTopic&topicId=<?=$topic->getId()?>" enctype="multipart/form-data">
            <?php
            ...
            <div id="blockTinyMce">
                ...
                <textarea name="tinyMCEtextarea" id="tinyMCEtextarea"><?=$topic->getContent()?></textarea>
            </div>
